...
public class ModificarProp2 extends javax.swing.JPanel {

    private ProgramaPrincipal Principal;
    private ArrayListPropiedad Propiedades;
    private Departamento aux;
    ...
    public ModificarProp2(ArrayListPropiedad Propiedades,ProgramaPrincipal Principal,Departamento aux) {
        initComponents();
        this.Propiedades=Propiedades;
        this.Principal=Principal;
        this.aux=aux;
        this.pisot.setText(""+aux.getPiso());
        this.Idt.setText(aux.getID());
    ...
    public Departamento getAux() {
        return aux;
    }

    public void setAux(Departamento aux) {
        this.aux = aux;
    }
    ...
    private void initComponents() {
        ...
        Piso.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        Piso.setText("Piso");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ModiPropLayout.createSequentialGroup()
                .addGroup(ModiPropLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(ModiPropLayout.createSequentialGroup()
                        ...
                        .addGroup(ModiPropLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(pisot, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                            .addComponent(Piso)
                            .addComponent(Id)
                            .addComponent(Idt)))
                    .addGroup(ModiPropLayout.createSequentialGroup()
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        String direccion,id; double vt,m2c,m2t; int ct,piso;
        if (Diret.getText().isEmpty() || CantAmbT.getText().isEmpty() || Vtt.getText().isEmpty() || M2tt.getText().isEmpty() || M2Ct.getText().isEmpty() || pisot.getText().isEmpty() || Idt.getText().isEmpty()){
        ...
        Propiedades.add(aux2,d1);
        Ventana_Mensaje("Se modificó la propiedad exitosamente!","Propiedad Modificada Correctamente");
        PanelAdmPropiedades a12=new PanelAdmPropiedades(Propiedades,this.Principal);
                this.setVisible(false);
                try {
                    this.finalize();
